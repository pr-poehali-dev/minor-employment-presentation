...
const blocks = [
  ...
  },
  {
    ...
    items: [
      ...
      "Не может быть ниже МРОТ при полной занятости (27 093 ₽/мес в 2025 г.)",
      "Удержание налогов (НДФЛ) — обязанность работодателя",
      "Отпуск — не менее 31 календарного дня (ТК РФ ст. 267)",
    ],
  },
  {
    icon: "Ban",
    ...
    items: [
      ...
      "Ночные смены (с 22:00 до 06:00) — до 18 лет",
      "Сверхурочная работа и работа в выходные без согласия",
      "Испытательный срок при приёме на работу до 18 лет",
    ],
  },
  {
    icon: "Scale",
