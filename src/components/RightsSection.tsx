...
const blocks = [
  ...
  },
  {
    ...
    items: [
      ...
      "Обязательный медосмотр при приёме на работу — за счёт работодателя (ТК РФ ст. 266)",
      "До 18 лет — ежегодный медосмотр обязателен для всех несовершеннолетних работников",
    ],
  },
  {
    icon: "Banknote",
    ...
    items: [
      ...
      "Отпуск — 31 календарный день; можно взять авансом до истечения 6 месяцев работы по заявлению",
      "Отпуск нельзя заменить денежной компенсацией или отозвать из него несовершеннолетнего (ТК РФ ст. 267)",
    ],
  },
  {
    icon: "Ban",
