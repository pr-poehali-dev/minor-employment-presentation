...
const vacancies = [
  ...
  {
    id: 3,
    title: "• Прополка и полив клумб\n• Уборка мусора\n• Покраска клумб и заборов",
    department: "МБУ \"Благоустройство\" · р.п. Воскресенское, пл. Ленина, д. 3",
    minAge: 14,
    hours: "Летний период",
    type: "Благоустройство",
    salary: "23 570 ₽/мес",
    description:
      "Работа на летний период по благоустройству территории:\n• Прополка и полив клумб;\n• Уборка мусора;\n• Покраска клумб и заборов.\n\nГрафик работы: с 09:00 до 16:00\n\nРаботодатель: МБУ «Благоустройство»\nАдрес: Нижегородская область, Воскресенский м.о., р.п. Воскресенское, пл. Ленина, д. 3",
    tags: [],
    restrictions: "С 14 лет при наличии письменного согласия родителей. Не более 4 ч/день в период учёбы.",
    contact: "8 (930) 293-20-05 — Лепёхин Алексей Сергеевич",
  },
];
