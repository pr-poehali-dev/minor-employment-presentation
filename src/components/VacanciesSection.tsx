...
const vacancies = [
  {
    ...
    contact: "8 (920) 077-03-30 — Матанцева Елена Леонидовна",
  },
  {
    id: 2,
    ...
    contact: "8 (952) 463-23-50 — Колотушкина Анастасия Михайловна",
  },
  {
    id: 3,
    title: "• Помощник администратора\n• Помощник по хозяйству и территории",
    department: "АНО ПОРТ «Воскресенское Поветлужье» · д. Бараново, Воскресенский м.о.",
    minAge: 16,
    hours: "Сезонная, временная",
    type: "Администратор",
    salary: "По согласованию",
    description:
      "Две позиции на сезонной основе:\n• Помощник администратора — работа на ресепшене, помощь в организации мероприятий;\n• Помощник по хозяйству и территории — поддержание порядка на объекте и прилегающей территории.\n\nРаботодатель: АНО ПОРТ «Воскресенское Поветлужье»\nАдрес: Нижегородская область, Воскресенский м.о., д. Бараново, Советская ул., д. 2",
    tags: [],
    restrictions: "С 16 лет.",
    contact: "8 (915) 468-46-80 — Алексеенко Виктория Валерьевна",
  },
  {
    id: 4,
    title: "Разнорабочий",
    department: "ИП Терехов Д.Н. · д. Мартьяново, Воскресенский м.о.",
    minAge: 16,
    hours: "Сезонная, почасовая",
    type: "Разнорабочий",
    salary: "По согласованию",
    description:
      "Сезонная работа разнорабочим с почасовой оплатой.\n\nРаботодатель: ИП Терехов Д.Н.\nАдрес: Нижегородская область, Воскресенский м.о., д. Мартьяново",
    tags: [],
    restrictions: "С 16 лет.",
    contact: "8 (926) 799-96-27 — Терехов Дмитрий Николаевич",
  },
];
