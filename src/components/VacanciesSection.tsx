...
const vacancies = [
  {
    id: 1,
    title: "Горничная",
    department: "ООО КомандаГорький НН",
    minAge: 14,
    hours: "Частичная занятость",
    type: "Лёгкий труд",
    salary: "до 200 ₽/час",
    description:
      "Уборка и поддержание чистоты в гостевых номерах и общих зонах. Работа в комфортных условиях, гибкий график — несколько часов в день или неделю.",
  ...
  },
  {
    ...
    salary: "до 200 ₽/час",
    description:
      "Помощь на кухне: подготовка ингредиентов, сервировка, поддержание порядка на рабочем месте. Работа в дружном коллективе, обучение на месте.",
    tags: ["Летний период", "Частичная занятость", "Обучение"],
    restrictions: "С 14 лет при наличии письменного согласия родителей. Запрещены работы с тяжёлым оборудованием.",
  },
  {
    id: 3,
    title: "Гид",
    ...
    salary: "до 200 ₽/час",
    description:
      "Проведение экскурсий и сопровождение гостей. Рассказ об истории и достопримечательностях Воскресенского района Нижегородской области. Отличный опыт для общительных подростков.",
    tags: ["Летний период", "На природе", "Общение"],
    restrictions: "С 14 лет при наличии письменного согласия родителей. Не более 4 ч/день в период учёбы.",
  },
];
