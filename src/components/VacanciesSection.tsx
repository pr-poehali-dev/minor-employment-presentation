...
const vacancies = [
  ...
  {
    id: 12,
    title: "Сборщики грибов",
    department: "ООО \"Агрокомбинат \"Ветлужский\"",
    minAge: 16,
    hours: "Сезонная работа",
    type: "Сельское хозяйство",
    salary: "от 27 093 ₽/мес",
    description:
      "Сезонная работа (на летний период) сборщиком грибов.\nВыполнение работ по сбору грибов на территории агрокомбината.\nРаботодатель: ООО «Агрокомбинат «Ветлужский».\nОплата труда — для начала МРОТ (27 093 ₽/мес), с перспективой роста.",
    tags: ["Сезонная работа", "Лето", "Без опыта", "Сельское хозяйство"],
    restrictions: "С 16 лет. Допускается при наличии письменного согласия родителей и медицинской справки.",
  },
  {
    id: 11,
    title: "Разнорабочий",
    department: "ООО \"Рельеф\" · г. Нижний Новгород, наб. Волжская, д. 23, пом. П4 · ОП: Воскресенский р-н, п. Калиниха, ул. Береговая, зд. 1/1",
    minAge: 16,
    hours: "Сезонная работа",
    type: "Разнорабочий",
    salary: "27 100 ₽/мес",
    description:
      "Сезонная работа (например, на лето) разнорабочим.\nВыполнение общих хозяйственных и вспомогательных работ.\nРаботодатель: ООО «Рельеф», юр. адрес: г. Нижний Новгород, наб. Волжская, д. 23, пом. П4.\nАдрес обособленного подразделения: Воскресенский район, п. Калиниха, ул. Береговая, зд. 1/1.\nОплата труда — 27 100 ₽/мес.",
    tags: ["Сезонная работа", "Лето", "Без опыта"],
    restrictions: "С 16 лет. Допускается при наличии письменного согласия родителей и медицинской справки.",
  },
  {
    id: 4,
